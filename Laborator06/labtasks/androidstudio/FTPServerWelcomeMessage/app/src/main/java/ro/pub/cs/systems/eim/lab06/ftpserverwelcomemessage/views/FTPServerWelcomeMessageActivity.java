    ...
    private class FTPServerCommunicationAsyncTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                serverSocket = new Socket(params[0],Constants.FTP_PORT);
                BufferedReader bufferedReader = Utilities.getReader(serverSocket);
                ...
                if (line.startsWith(Constants.FTP_MULTILINE_START_CODE)) {
                    ...
                    while((line = bufferedReader.readLine()) != null) {
                        ...
                        if (!line.startsWith(Constants.FTP_MULTILINE_END_CODE2) &&
                                !Constants.FTP_MULTILINE_END_CODE1.equals(line)){
